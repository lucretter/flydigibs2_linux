...
<img width="932" height="859" alt="image" src="https://github.com/user-attachments/assets/0e8bcf1e-bfe5-4dc5-a6f6-0f9251dbff3a" />
...
- 🧠 **Smart Mode** — Automatic fan control based on CPU, GPU or PC average temperature  
